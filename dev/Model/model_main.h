 ...
 * @todo Create a threaded looping function that will step through commands.
 * @todo Include logging of model state.
 */
namespace model {
	...
	*/
	 ...
	 * @todo create a Node_Shut_Down network message.
	 */
	void clean_up();
}
#endif 