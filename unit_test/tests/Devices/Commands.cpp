...
TEST_F(Commands_Test, Device_Off) 
{
	...
	ds = static_cast<Device*>(device_utilities::command_device(dl, new Off(dl)));
	testing_utilities::device_utilities::check_state(dl, ds);
}
...
TEST_F(Commands_Test, Device_Assign_Channel) 
{
	...
	Device* ds = static_cast<Device*>(device_utilities::command_device(dl, new Assign(dl, 50)));
	...
	ds = static_cast<Device*>(device_utilities::command_device(dl, new Assign(dl, 2, 50)));
