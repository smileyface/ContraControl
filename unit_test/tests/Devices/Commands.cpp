...
TEST_F(Commands_Test, Device_Initalize) 
{
	...
	ds = static_cast<Device*>(device_utilities::command_device(dl, controller::commander->make_command<Initalize_Device>(dl, "Test1")));
	testing_utilities::device_utilities::check_state(dl, ds);
}
TEST_F(Commands_Test, Device_On)
{
	Device* ds = static_cast<Device*>(device_utilities::command_device(dl, controller::commander->make_command<On>(dl)));
	testing_utilities::device_utilities::check_state(dl, ds);
	ds = static_cast<Device*>(device_utilities::command_device(dl, controller::commander->make_command<Initalize_Device>(dl, "Test1")));
	ds = static_cast<Device*>(device_utilities::command_device(dl, controller::commander->make_command<On>(dl)));
	testing_utilities::device_utilities::check_state(dl, ds);
}

TEST_F(Commands_Test, Device_Off) 
{
	Device * ds = static_cast<Device*>(device_utilities::command_device(dl, controller::commander->make_command<Off>(dl)));
	testing_utilities::device_utilities::check_state(dl, ds);
	ds = static_cast<Device*>(device_utilities::command_device(dl, controller::commander->make_command<Initalize_Device>(dl, "Test1")));
	ds = static_cast<Device*>(device_utilities::command_device(dl, controller::commander->make_command<On>(dl)));
	testing_utilities::device_utilities::check_state(dl, ds);

	ds = static_cast<Device*>(device_utilities::command_device(dl, controller::commander->make_command<Off>(dl)));
	testing_utilities::device_utilities::check_state(dl, ds);
}
...
TEST_F(Commands_Test, Device_Assign_Channel) 
{
	...
	Device* ds = static_cast<Device*>(device_utilities::command_device(dl, controller::commander->make_command <Assign>(dl, 50)));
	...
	ds = static_cast<Device*>(device_utilities::command_device(dl, controller::commander->make_command <Assign>(dl, 2, 50)));
